...
# SETTING UP OF CAMERA TO 0 YOU CAN
# EVEN CHOOSE 1 IN PLACE OF 0
...
while True:
	...
	for face in faces:
		...
		if Eye_Rat < 0.25:
			...
			cv2.putText(frame, "You are Sleeping Please wake up!!", (50, 450),
						cv2.FONT_HERSHEY_PLAIN, 2, (21, 56, 212), 3)
                
			# CALLING THE AUDIO FUNCTION OF TEXT TO 
			# AUDIO FOR ALERTING THE PERSON
			engine.say("You are Sleeping Please wake up!!")
			engine.runAndWait()
